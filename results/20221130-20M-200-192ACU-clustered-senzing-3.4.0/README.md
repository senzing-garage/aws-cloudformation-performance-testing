# senzing-test-results-20221130-20M-200-192ACU-clustered-senzing-3.4.0
...
1. Performed: Nov 30, 2022
2. Senzing version: 3.4.0.22333
3. Instructions:
...
1. Inserts per second:
    ...
    1. Average after warm-up: 2660/second
    1. Average over entire run: 2331/second
    1. Time to load 20M: 2.37 hours
    1. Records in dead-letter queue: 0
    1. Total Billed read IOPS:        6,491
    1. Total Billed write IOPS:  78,340,242
...
G2=> SELECT NOW(), COUNT(*) FROM DSRC_RECORD;
              now              |  count
-------------------------------+----------
 2022-11-30 16:30:34.892212+00 | 20000000
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM OBS_ENT;
              now              |  count
-------------------------------+----------
 2022-11-30 16:31:35.305114+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT;
              now              |  count
-------------------------------+----------
 2022-11-30 16:31:44.028929+00 | 17478385
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT_OKEY;
              now              |  count
-------------------------------+----------
 2022-11-30 16:31:49.343729+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2022-11-30 16:31:52.110311+00 |     0
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_RELATE;
              now              |  count
-------------------------------+---------
 2022-11-30 16:31:57.400578+00 | 9125665
(1 row)
...
-------------------------+------------------+----------+--------------
 2022-11-30 14:01:25.869 | 140717.829793342 | 20000000 | 02:22:07.704
(1 row)
