# senzing-test-results-20210713-20M-200-192ACU-clustered-10records-per-message-senzing-2.8.0
...
1. Inserts per second:
    1. Peak: 2877/second
    1. Warm-up: 1.2 hour
    1. Average after warm-up: 2078/second
    1. Average over entire run: 1550/second
    1. Time to load 20M: 3.5 hours
    2. Records in dead-letter queue: 0
    3. See [dsrc_record.csv](data/dsrc_record.csv)

Note: `SELECT NOW(), COUNT(*) FROM DSRC_RECORD;` = 19999999
