# senzing-test-results-20220825-20M-200-192ACU-clustered-senzing-3.2.0-embedded
...
1. Inserts per second:
    ...
    1. Average after warm-up: 2745/second
    1. Average over entire run: 2331/second
    1. Time to load 20M: 2.37 hours
    1. Records in dead-letter queue: 0
    1. Total Billed read IOPS:    8,075,496
    1. Total Billed write IOPS: 116,664,154
    1. See [dsrc_record.csv](data/dsrc_record.csv)

Note:  This is using local senzing data.  Withinfo disabled.

- Max Stream-loader tasks: 55
- Max Redoer-loader tasks: 10
...
G2=> SELECT NOW(), COUNT(*) FROM DSRC_RECORD;
              now              |  count
-------------------------------+----------
 2022-08-25 18:25:10.129276+00 | 20000000
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2022-08-25 18:26:10.493001+00 |     0
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM OBS_ENT;
              now              |  count
-------------------------------+----------
 2022-08-25 18:26:14.616895+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT;
              now              |  count
-------------------------------+----------
 2022-08-25 18:27:15.685825+00 | 17478718
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT_OKEY;
              now              |  count
-------------------------------+----------
 2022-08-25 18:27:30.588554+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_RELATE;
              now              |  count
-------------------------------+---------
 2022-08-25 18:27:42.638449+00 | 9123494
(1 row)
...
-------------------------+------------------+----------+--------------
 2022-08-25 15:20:51.736 | 141692.481265597 | 20000000 | 02:21:09.045
(1 row)
