# senzing-test-results-20231016-20M-provisioned-r7g-8x-cluster-senzing-3.8.0
...
1. Max tasks:
    ...
    - Max Stream-loader tasks: 33
    - Max Redoer tasks: 2

1. Notes:
    - db.r7g.8xlarge RES cluster seems to be running at 61% CPU with 125 loaders running.
