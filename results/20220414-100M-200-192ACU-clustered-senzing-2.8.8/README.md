# senzing-test-results-20220414-100M-200-192ACU-clustered-senzing-2.8.8
...
1. Inserts per second:
    1. Peak: 2665/second
    1. Warm-up: 1.13 hours
    1. Average after warm-up: 1548/second
    1. Average over entire run: 1497/second
    1. Time to load 20M: 23.12 hours
    2. Records in dead-letter queue: 8
    3. See [dsrc_record.csv](data/dsrc_record.csv)

Note:  This is using local senzing data.  Withinfo disabled.

*DID NOT COMPLETE* redoes, stopped at the 31 hour mark.
