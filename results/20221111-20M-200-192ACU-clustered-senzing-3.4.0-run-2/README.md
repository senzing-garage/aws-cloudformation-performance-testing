# senzing-test-results-20221111-20M-200-192ACU-clustered-senzing-3.4.0-run-2
...
1. Inserts per second:
    1. Peak: 2176/second
    1. Warm-up: 0.53 hours
    1. Average after warm-up: 1714/second
    1. Average over entire run: 1558/second
    1. Time to load 20M: 3.55 hours
    1. Records in dead-letter queue: 0
    1. Total Billed read IOPS:   61,480,460
    1. Total Billed write IOPS: 126,806,787
...
G2=> SELECT NOW(), COUNT(*) FROM DSRC_RECORD;
              now              |  count
-------------------------------+----------
 2022-11-11 23:40:52.371228+00 | 20000000
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM OBS_ENT;
              now              |  count
-------------------------------+----------
 2022-11-11 23:41:02.950486+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT;
              now              |  count
-------------------------------+----------
 2022-11-11 23:43:02.094457+00 | 17478408
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT_OKEY;
              now              |  count
-------------------------------+----------
 2022-11-11 23:43:10.482771+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2022-11-11 23:43:15.176563+00 |     0
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_RELATE;
              now              |  count
-------------------------------+---------
 2022-11-11 23:43:19.359198+00 | 9125911
(1 row)
...
-------------------------+------------------+----------+-------------
 2022-11-11 19:58:55.727 | 94009.0389690969 | 20000000 | 03:32:44.73
(1 row)
