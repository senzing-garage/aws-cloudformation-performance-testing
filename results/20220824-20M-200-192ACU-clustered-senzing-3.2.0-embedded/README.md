# senzing-test-results-202208-24-20M-200-192ACU-clustered-senzing-3.2.0-embedded
...
1. Performed: Aug 24, 2022
2. Senzing version: 3.2.0.22229
3. Instructions:
...
1. Inserts per second:
    1. Peak: 1926/second
    1. Warm-up: 2.68 hours
    1. Average after warm-up: 1648/second
    1. Average over entire run: 1328/second
    1. Time to load 20M: 4.15 hours
    1. Records in dead-letter queue: 0
    1. Total Billed read IOPS:   44,256,503
    1. Total Billed write IOPS: 116,097,833
    1. See [dsrc_record.csv](data/dsrc_record.csv)

Note:  This is using local senzing data.  Withinfo disabled.

- Max Stream-loader tasks: 25
- Max Redoer-loader tasks:  9
...
G2=> SELECT NOW(), COUNT(*) FROM DSRC_RECORD;
              now              |  count
-------------------------------+----------
 2022-08-25 00:28:12.144162+00 | 20000000
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2022-08-25 00:28:17.807142+00 |     0
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM OBS_ENT;
              now              |  count
-------------------------------+----------
 2022-08-25 00:28:22.315484+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT;
              now              |  count
-------------------------------+----------
 2022-08-25 00:28:48.257915+00 | 17478679
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT_OKEY;
             now              |  count
------------------------------+----------
 2022-08-25 00:28:55.53926+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_RELATE;
              now              |  count
-------------------------------+---------
 2022-08-25 00:29:01.127979+00 | 9123060
(1 row)
...
-------------------------+------------------+----------+--------------
 2022-08-24 19:59:51.151 | 79954.4099954206 | 20000000 | 04:10:08.553
(1 row)
```
