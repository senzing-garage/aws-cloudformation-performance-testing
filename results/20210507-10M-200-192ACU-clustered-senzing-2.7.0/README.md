# senzing-test-results-20210504-100M-300-192ACU-clustered-senzing-2.7.0
...
1. Inserts per second:
    1. Peak: 0000/second
    1. Warm-up: *.* hours
    1. Average after warm-up: 0000/second
    1. Average over entire run: 0000/second
    1. Time to load 100M: *.* hours
