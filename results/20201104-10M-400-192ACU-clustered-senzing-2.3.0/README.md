# senzing-test-results-20201104-10M-400-192ACU-clustered-senzing-2.3.0
...
1. Instructions:
   [advanced](https://github.com/senzing-garage/docker-compose-aws-ecscli-demo/tree/issue-39.dockter.1/docs/advanced-cluster)
    1. [Pinned version](https://github.com/senzing-garage/docker-compose-aws-ecscli-demo/tree/030496f76bb6b6afe56d05040ebf9877f93fb405/docs/advanced-cluster)
...
1. Stream-loader containers
    1. 1 Service
    1. Scale: 1 - 400
    1. AutoScale threshold: TargetValue=50.0
...
1. Inserts per second:
    1. Peak: 2652/second
    1. Warm-up: 1.5 hours
    1. Average after warm-up: 1271/second
    1. Average over entire run: 872/second
    1. Time to load 10M: 3.9 hours
