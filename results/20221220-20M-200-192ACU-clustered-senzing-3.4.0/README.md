# senzing-test-results-20221220-20M-200-192ACU-clustered-senzing-3.4.0
...
1. Inserts per second:
    ...
    1. Average after warm-up: 2438/second
    1. Average over entire run: 2083/second
    1. Time to load 20M: 2.65 hours
    1. Records in dead-letter queue: 0
    1. Total Billed read IOPS:    34,298,747
    1. Total Billed write IOPS:  103,727,910
...
G2=> SELECT NOW(), COUNT(*) FROM DSRC_RECORD;
              now              |  count
-------------------------------+----------
 2022-12-20 16:44:08.163288+00 | 20000000
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM OBS_ENT;
              now              |  count
-------------------------------+----------
 2022-12-20 16:51:25.033793+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT;
              now              |  count
-------------------------------+----------
 2022-12-20 16:54:36.649317+00 | 17478390
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT_OKEY;
              now              |  count
-------------------------------+----------
 2022-12-20 16:54:49.237877+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2022-12-20 16:55:50.791299+00 |     0
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_RELATE;
              now              |  count
-------------------------------+---------
 2022-12-20 16:56:12.812878+00 | 9122655
(1 row)
...
-------------------------+------------------+----------+--------------
 2022-12-20 13:59:34.079 | 126208.100751085 | 20000000 | 02:38:28.106
(1 row)
