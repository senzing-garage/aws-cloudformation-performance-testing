# senzing-test-results-20220429-20M-200-192ACU-clustered-senzing-3.0.0
...
1. Performed: Apr 29, 2022
2. Senzing version: 3.0.0-22119
3. Instructions:
...
1. Inserts per second:
    1. Peak: 2868/second
    1. Warm-up: 45 mins
    1. Average after warm-up: 1967/second
    1. Average over entire run: 1667/second
    1. Time to load 20M: 3.32 hours
    1. Records in dead-letter queue: 0
    1. Total Billed read IOPS:  87380092
    1. Total Billed write IOPS:  148886718
...
G2=> SELECT NOW(), COUNT(*) FROM DSRC_RECORD;
              now              |  count
-------------------------------+----------
 2022-04-30 13:22:18.384674+00 | 20000000
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2022-04-30 13:23:17.174897+00 |     0
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM OBS_ENT;
              now              |  count
-------------------------------+----------
 2022-04-30 13:23:17.186632+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT;
              now              |  count
-------------------------------+----------
 2022-04-30 13:24:26.057189+00 | 17480819
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT_OKEY;
              now              |  count
-------------------------------+----------
 2022-04-30 13:24:37.229131+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_RELATE;
              now              |  count
-------------------------------+---------
 2022-04-30 13:24:45.597879+00 | 9103915
(1 row)
...
-------------------------+------------------+----------+--------------
 2022-04-30 00:55:35.017 | 100488.449229593 | 20000000 | 03:19:01.671
(1 row)
```
