# senzing-test-results-20211006-20M-200-192ACU-clustered-senzing-2.8.2-encrypted
...
1. Inserts per second:
    1. Peak: 2476/second
    1. Warm-up: 1.8 hours
    1. Average after warm-up: 1629/second
    1. Average over entire run: 1203/second
    1. Time to load 20M: 4.6 hours
    2. Records in dead-letter queue: 0
    3. See [dsrc_record.csv](data/dsrc_record.csv)

Note:  This is using the example encryption library and local senzing data.
