# senzing-test-results-20221121-20M-200-192ACU-clustered-senzing-3.4.0
...
1. Performed: Nov 21, 2022
2. Senzing version: 3.4.0.22322
3. Instructions:
...
1. Inserts per second:
    ...
    1. Average after warm-up: 2488/second
    1. Average over entire run: 2179/second
    1. Time to load 20M: 2.53 hours
    1. Records in dead-letter queue: 0
    1. Total Billed read IOPS:   30,837,939
    1. Total Billed write IOPS:  99,432,993
...
G2=> SELECT NOW(), COUNT(*) FROM DSRC_RECORD;
             now              |  count
------------------------------+----------
 2022-11-21 17:03:51.53658+00 | 20000000
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM OBS_ENT;
              now              |  count
-------------------------------+----------
 2022-11-21 17:04:57.644006+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT;
              now              |  count
-------------------------------+----------
 2022-11-21 17:05:23.114624+00 | 17478409
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT_OKEY;
              now              |  count
-------------------------------+----------
 2022-11-21 17:05:32.101634+00 | 19999959
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2022-11-21 17:05:38.974592+00 |     0
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_RELATE;
              now              |  count
-------------------------------+---------
 2022-11-21 17:05:43.426756+00 | 9122494
(1 row)
...
-------------------------+------------------+----------+--------------
 2022-11-21 14:05:57.047 | 132124.307833782 | 20000000 | 02:31:22.356
(1 row)
