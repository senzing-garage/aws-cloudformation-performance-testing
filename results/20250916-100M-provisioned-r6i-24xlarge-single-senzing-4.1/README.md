# senzing-test-results-20250916-100M-provisioned-r6i-24xlarge-single-senzing-4.1
...
1. Inserts per second:
    ...
    1. Average over entire run: 2969/second
    1. Time to load 25M: 9.35 hours
    1. Records in dead-letter queue: 0
    1. Volume read IOPS:     33,886,974
    1. Volume write IOPS:   473,285,471
    1. See [dsrc_record.csv](data/dsrc_record.csv)

1. Max tasks:

    - Max Consumer tasks: 97
    - Max Redoer tasks: 99
...
G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2025-09-17 14:35:58.684831+00 |     0
(1 row)

G2=> \copy (SELECT date_trunc('minute', first_seen_dt) as time, count(*) inserts_per_minute FROM dsrc_record GROUP BY time ORDER BY time desc) To '/tmp/test.csv' With CSV
COPY 562
G2=> SELECT NOW(), COUNT(*) FROM DSRC_RECORD;
              now              |   count
-------------------------------+-----------
 2025-09-17 14:41:44.594055+00 | 100000000
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM OBS_ENT;
              now              |  count
-------------------------------+----------
 2025-09-17 14:48:10.582091+00 | 99998927
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT_OKEY;
              now              |  count
-------------------------------+----------
 2025-09-17 14:50:18.939423+00 | 99998927
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM SYS_EVAL_QUEUE;
              now              | count
-------------------------------+-------
 2025-09-17 14:52:24.025474+00 |     0
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_ENT WHERE ent_state != 0 ;
              now              | count
-------------------------------+-------
 2025-09-17 14:52:29.357463+00 |   162
(1 row)

G2=> SELECT NOW(), COUNT(*) FROM RES_RELATE;
              now              |  count
-------------------------------+----------
 2025-09-17 14:52:35.560719+00 | 32366874
(1 row)
...
-------------------------+-------------------------+-----------+--------------+-----------------------
 2025-09-16 17:41:17.338 | 178119.2812578261159308 | 100000000 | 09:21:25.292 | 2968.6546876304352655
(1 row)
